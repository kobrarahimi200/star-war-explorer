    ...
    <template v-else>
      <section class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
        ...
        <dl class="grid grid-cols-2 gap-4 sm:grid-cols-5">
          <div>
            <dt class="text-sm text-gray-500">Episode</dt>
            <dd class="font-semibold">{{ film.episode_id }}</dd>
          </div>
          <div>
            <dt class="text-sm text-gray-500">Director</dt>
            <dd class="font-semibold">{{ film.director }}</dd>
          </div>
          <div>
            <dt class="text-sm text-gray-500">Producer</dt>
            <dd class="font-semibold">{{ film.producer }}</dd>
          </div>
          <div>
            <dt class="text-sm text-gray-500">Release Date</dt>
            <dd class="font-semibold">{{ film.release_date }}</dd>
          </div>
        </dl>
